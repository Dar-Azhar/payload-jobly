...
export default function Header({ theme = 'dark', menuItems = menuItemsx }: HeaderProps) {
    ...
    return (
        <header className={`bg-background shadow-sm fixed w-full z-50`}>
            ...
            {isMobileMenuOpen && (
                <div
                    className={`md:hidden ${isDarkTheme ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
